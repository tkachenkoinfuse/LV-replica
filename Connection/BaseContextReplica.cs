...
{
    public class BaseContextReplica : DbContext
    {
        ...
        public DbSet<Contacts> contacts_view { get; set; }
        ...
        public DbSet<FeedLog> feed_log_view { get; set; }
        public DbSet<LSLeads> l_s_leads_view { get; set; }
        ...
        {
            optionsBuilder.UseMySQL(Constant.connectionStringReplicaDB);
        }
    }
}
